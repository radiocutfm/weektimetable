...
def get_version():
    main_file = os.path.join(CURDIR, "src/weektimetable", "__init__.py")
...
setup(
    ...
    keywords='parser schedule timetable',  # Optional
    ...
    install_requires=['pytz', 'six'],  # Optional
